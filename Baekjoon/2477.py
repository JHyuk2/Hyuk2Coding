...
cut_width = [num for idx, num in find_tmp if idx == 1 or idx == 2][0]
cut_height = [num for idx, num in find_tmp if idx == 3 or idx == 4][0]

cut_area = (max_width[1] - cut_width) * (max_height[1] - cut_height)

# cut_area_ele = [i for i in d if i is not max_width and i is not max_height and i not in find_tmp]
